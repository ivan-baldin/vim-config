...
syn keyword htmlTagName contained details dialog embed figcaption figure
syn keyword htmlTagName contained footer header keygen main mark menuitem
syn keyword htmlTagName contained meter nav output progress rp rt ruby section
syn keyword htmlTagName contained source summary svg time track video wbr
...
" html 5 arg names
syn match   htmlArg contained "\sdata[\-A-Za-z0-9_]*"
